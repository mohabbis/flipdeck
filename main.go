...
// init sets up web server for Vercel
func init() {
	// Note: Vercel automatically detects Handler(w http.ResponseWriter, r *http.Request) function
}
...
func startWebServer(port int) {
	...
	// Handler function that can be used by Vercel
...
<body>
	...
	// Try to start server, but don't block on Vercel
	go func() {
